...
private alias HasEndpointBody = (Kpbb::Request::Channel::Feed::Inbound::Endpoint::Create | Kpbb::Request::Channel::Feed::Inbound::Endpoint::Update)

class Kpbb::Validator::Channel::Feed::Inbound::Endpoint::DefaultBodyYaml < Accord::Validator
